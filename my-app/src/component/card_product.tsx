    ...
    return (
        <>
            <Link href={"http://localhost:3000/products/slug"} >
                ...
                >
                    <figure><img src="https://www.richeesefactory.com/sites/default/media/library/ds-richicken.jpg" alt="Shoes"
                    /></figure>
                    ...
                    <button className="btn btn-outline btn-success btn-sm h-fit absolute left-3 top-3">
                        <div className="flex flex-col py-1">
                            <svg className="h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
